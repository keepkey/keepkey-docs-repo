...
const DogecoinBalance = () => {
    ...
    const requestBitcoinBalance = async () => {
        ...
        try {
            const balance = await window.keepkey.dogecoin.request({
    ...
    return (
        <div style={{ padding: '2rem', textAlign: 'center', fontFamily: 'Arial, sans-serif' }}>
            ...
            <p style={{ marginBottom: '1rem', color: '#6B7280' }}>Get your Dogecoin account balance instantly using KeepKey</p>
            <CustomButton onClick={requestBitcoinBalance}>
                Request Dogecoin balance
            </CustomButton>
                ...
                <CustomCard>
                    ...
                    {balance !== null && (
                        <>
                            ...
                            <p style={{ color: '#1F2937' }}>{formatBalance(balance)} DOGE</p>
...
export default DogecoinBalance;
