...
const BitcoinCashSendTransaction = () => {
    const [address, setAddress] = useState('qpd00ucur9gl7rzwe7lqmu9yljr9ajv92q09a0jdrl');
    ...
    const handleSend = async () => {
        ...
        try {
            const signedTx = await window.keepkey.bitcoincash.request({
                method: 'transfer',
                params: [txParams],
            });
...
export default BitcoinCashSendTransaction;
