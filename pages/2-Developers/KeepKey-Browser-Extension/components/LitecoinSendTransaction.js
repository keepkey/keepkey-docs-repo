...
const LitecoinSendTransaction = () => {
    const [address, setAddress] = useState('LMcHLHjcAhMtM6SPQ7Da9acBQWcviaX2Fu');
    ...
    const handleSend = async () => {
        ...
        try {
            const signedTx = await window.keepkey.litecoin.request({
                method: 'transfer',
                params: [txParams],
            });
    ...
    return (
        <div style={{ padding: '2rem', textAlign: 'center', fontFamily: 'Arial, sans-serif' }}>
            ...
            <p style={{ marginBottom: '1rem', color: '#6B7280' }}>Transfer Litecoin securely using KeepKey</p>
...
export default LitecoinSendTransaction;
