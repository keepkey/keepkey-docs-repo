...
const ThorchainSendTransaction = () => {
    const [address, setAddress] = useState('thor1sjg2y8rz78d9dscsjenveg3k3jtkuyj46wl5ec');
    ...
    const handleSend = async () => {
        ...
        try {
            const signedTx = await window.keepkey.thorchain.request({
                method: 'transfer',
                params: [txParams],
            });
...
export default ThorchainSendTransaction;
