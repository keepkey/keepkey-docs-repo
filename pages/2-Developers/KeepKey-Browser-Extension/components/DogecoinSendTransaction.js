...
const DogecoinSendTransaction = () => {
    const [address, setAddress] = useState('DNchRDXhaW2uPusLVQWZZbQ5QQnzYmarWJ');
    ...
    const handleSend = async () => {
        ...
        try {
            const signedTx = await window.keepkey.dogecoin.request({
                method: 'transfer',
                params: [txParams],
            });
...
export default DogecoinSendTransaction;
