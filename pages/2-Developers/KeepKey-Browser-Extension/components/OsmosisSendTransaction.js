...
const OsmosisSendTransaction = () => {
    const [address, setAddress] = useState('osmo1hp7gnr07wprd75f4j4aze9a94aejfcqdccqdht');
    ...
    const handleSend = async () => {
        ...
        try {
            const signedTx = await window.keepkey.osmosis.request({
                method: 'transfer',
                params: [txParams],
            });
    ...
    return (
        <div style={{ padding: '2rem', textAlign: 'center', fontFamily: 'Arial, sans-serif' }}>
            <h1 style={{ color: '#1D4ED8' }}>Send Osmosis</h1>
            <p style={{ marginBottom: '1rem', color: '#6B7280' }}>Transfer Osmosis securely using KeepKey</p>
...
export default OsmosisSendTransaction;
