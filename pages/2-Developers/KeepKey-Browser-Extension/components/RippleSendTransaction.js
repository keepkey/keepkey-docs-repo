...
const RippleSendTransaction = () => {
    const [address, setAddress] = useState('rGdMfVVZwUbqAxs5zucKHUpFgFTcPPj5Cn');
    ...
    const handleSend = async () => {
        ...
        try {
            const signedTx = await window.keepkey.ripple.request({
                method: 'transfer',
                params: [txParams],
            });
...
export default RippleSendTransaction;
